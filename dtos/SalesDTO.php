...
class SalesDTO
{
    ...
    public function __construct(array $data = [], PaginationDTO $pagination = null)
    {
        ...
        foreach ($data as $item) {
            if ($item instanceof SaleDTO) {
                $this->data[] = $item;
            } elseif (is_array($item)) {
                $this->data[] = SaleDTO::fromArray($item);
            }
        }
    }
    ...
    {
        $dataArray = array_map(function ($sale) {
            return $sale instanceof SaleDTO ? $sale->toArray() : $sale;
        }, $this->data);
     ...
     */
    public function getFirst(): ?SaleDTO
    {
