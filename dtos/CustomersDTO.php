...
class CustomersDTO
{
    ...
    public function __construct(array $data = [], PaginationDTO $pagination = null)
    {
        ...
        foreach ($data as $item) {
            if ($item instanceof CustomerDTO) {
                ...
                $this->data[] = CustomerDTO::fromArray($item);
            }
        }
    }
    ...
    {
        $dataArray = array_map(function ($customer) {
            return $customer instanceof CustomerDTO ? $customer->toArray() : $customer;
        }, $this->data);
    ...
    /**
     * Retorna o primeiro cliente da lista (útil para validações)
     */
    public function getFirst(): ?CustomerDTO
    {
